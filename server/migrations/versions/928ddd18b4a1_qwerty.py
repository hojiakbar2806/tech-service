...
Revision ID: 928ddd18b4a1
Revises: 
Create Date: 2025-06-02 07:56:54.489757
...
def upgrade() -> None:
    ...
    sa.Column('is_legal_entity', sa.Boolean(), nullable=True),
    ...
    sa.Column('for_action', sa.String(), nullable=True),
